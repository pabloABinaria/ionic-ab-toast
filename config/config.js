 ...
 * | `ToastAbEnter`             | `string`            | The name of the transition to use while a ToastAb is presented.                                                                                    |
 * | `ToastAbLeave`             | `string`            | The name of the transition to use while a ToastAb is dismissed.                                                                                    |
 *
**/
var Config = (function () {
    function Config() {
